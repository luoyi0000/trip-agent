...
class Attraction(BaseModel):
    ...
    image_search_keyword: Optional[str] = Field(default=None, description="英文图片搜索关键词,用于Unsplash搜图")
...
class TripPlanTaskStatus(BaseModel):
    ...
    data: Optional[TripPlan] = Field(default=None, description="旅行计划数据(仅completed时)")
